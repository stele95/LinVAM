...
class Ui_MainWidget(object):
    def setupUi(self, MainWidget):
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(200, 45))
        ...
        self.save = QtWidgets.QPushButton(parent=MainWidget)
        self.save.setMinimumSize(QtCore.QSize(130, 0))
        self.save.setObjectName("save")
        self.horizontalLayout_2.addWidget(self.save)
        self.quit = QtWidgets.QPushButton(parent=MainWidget)
        self.quit.setMinimumSize(QtCore.QSize(130, 0))
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.save.setText(_translate("MainWidget", "Save profiles"))
        self.quit.setText(_translate("MainWidget", "Quit without saving"))
