...
class Ui_ProfileEditDialog(object):
    def setupUi(self, ProfileEditDialog):
        ...
        self.duplicateCmd = QtWidgets.QPushButton(parent=self.groupBox)
        self.duplicateCmd.setMinimumSize(QtCore.QSize(130, 0))
        self.duplicateCmd.setObjectName("duplicateCmd")
        self.horizontalLayout_2.addWidget(self.duplicateCmd)
    ...
    def retranslateUi(self, ProfileEditDialog):
        ...
        self.duplicateCmd.setText(_translate("ProfileEditDialog", "Duplicate"))
