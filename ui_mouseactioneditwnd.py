...
class Ui_MouseActionEditDialog(object):
    def setupUi(self, MouseActionEditDialog):
        ...
        self.mouseActionTabWidget = QtWidgets.QTabWidget(parent=MouseActionEditDialog)
        ...
        self.moveTo = QtWidgets.QRadioButton(parent=self.moveActionTab)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.moveActionTab)
        self.label_2.setMinimumSize(QtCore.QSize(25, 0))
        self.label_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_2.addWidget(self.label_2)
        self.xEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        self.xEdit.setObjectName("xEdit")
        self.horizontalLayout_2.addWidget(self.xEdit)
        self.label_3 = QtWidgets.QLabel(parent=self.moveActionTab)
        ...
        self.yEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        ...
        self.moveOffset = QtWidgets.QRadioButton(parent=self.moveActionTab)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.moveActionTab)
        ...
        self.xOffsetEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        self.xOffsetEdit.setObjectName("xOffsetEdit")
        self.horizontalLayout_3.addWidget(self.xOffsetEdit)
        self.label_4 = QtWidgets.QLabel(parent=self.moveActionTab)
        self.label_4.setMinimumSize(QtCore.QSize(70, 0))
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.label_6 = QtWidgets.QLabel(parent=self.moveActionTab)
        ...
        self.yOffsetEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        self.yOffsetEdit.setObjectName("yOffsetEdit")
        self.horizontalLayout_3.addWidget(self.yOffsetEdit)
        self.label_7 = QtWidgets.QLabel(parent=self.moveActionTab)
        ...
        self.scrollUp = QtWidgets.QRadioButton(parent=self.moveActionTab)
        ...
        self.scrollUpEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        self.scrollUpEdit.setObjectName("scrollUpEdit")
        self.horizontalLayout_4.addWidget(self.scrollUpEdit)
        self.label_8 = QtWidgets.QLabel(parent=self.moveActionTab)
        self.label_8.setMinimumSize(QtCore.QSize(80, 0))
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_4.addWidget(self.label_8)
        self.scrollDown = QtWidgets.QRadioButton(parent=self.moveActionTab)
        ...
        self.scrollDownEdit = QtWidgets.QLineEdit(parent=self.moveActionTab)
        self.scrollDownEdit.setObjectName("scrollDownEdit")
        self.horizontalLayout_4.addWidget(self.scrollDownEdit)
        self.label_9 = QtWidgets.QLabel(parent=self.moveActionTab)
        ...
        self.ok = QtWidgets.QPushButton(parent=MouseActionEditDialog)
        self.ok.setMinimumSize(QtCore.QSize(130, 0))
        self.ok.setAutoDefault(False)
        self.ok.setObjectName("ok")
        self.horizontalLayout.addWidget(self.ok)
        self.cancel = QtWidgets.QPushButton(parent=MouseActionEditDialog)
