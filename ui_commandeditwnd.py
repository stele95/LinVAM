...
class Ui_CommandEditDialog(object):
    def setupUi(self, CommandEditDialog):
        ...
        self.thresholdSpin = QtWidgets.QSpinBox(parent=CommandEditDialog)
